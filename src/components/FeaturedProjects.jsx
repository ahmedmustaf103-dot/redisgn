      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap gap-3 justify-center mb-12">
          <select
            ...
            className="px-4 py-2 bg-cream border border-stone-300 text-charcoal text-sm focus:border-waten-accent focus:ring-1 focus:ring-waten-accent outline-none rounded"
              ...
              <a href={project.link} target="_blank" rel="noopener noreferrer" className="block">
                <div className="aspect-[4/3] overflow-hidden relative">
                  ...
                  <div className="absolute top-3 left-3 flex flex-wrap gap-2">
                    <span className="px-2 py-1 bg-waten-dark/90 text-white text-xs font-medium rounded">
                      {project.location}
                    </span>
                    ...
                    <span className={`px-2 py-1 text-xs font-medium rounded ${
                      project.status === 'Completed' ? 'bg-waten-accent/90 text-white' : 'bg-amber-500/90 text-white'
                    }`}>
                      {project.status}
                    </span>
                  </div>
